...
**ข้อกำหนดเพิ่มเติม:**
* หากคำบรรยายมีข้อมูลไม่เพียงพอในการตัดสินใจความสุกของเมล่อน (เช่น ข้อมูลไม่ครบ 6 มิติ) ให้ตอบว่า "ไม่สามารถพิจารณาระดับความสุกได้"
...
* หากมีมิติเหล่านี้ไม่ครบ (มีค่าใดค่าหนึ่งเป็น null หรือไม่มีในคำบรรยาย) ให้ตอบว่า "ripeness": "ข้อมูลไม่เพียงพอ" และอธิบายใน reason เช่น:
"ข้อมูลไม่ครบ 6 มิติ ได้แก่ สีของเนื้อเมล่อน, ความแน่นเนื้อ, อายุการเก็บรักษาก่อนเน่าเสีย ทำให้ไม่สามารถพิจารณาระดับความสุกได้"
         """
        ...
        if msg["role"] == "user":
            ...
            try:
                ...
                with st.container():
                    ...
                    col1.metric("ความแน่นเนื้อ", data.get("firmness", "ไม่ระบุ"))
