...
* **ให้เขียนคำอธิบายในช่อง "reason" อย่างละเอียด โดยวิเคราะห์แต่ละมิติ (1-6) ว่าอยู่ในเกณฑ์ของระดับใด พร้อมเปรียบเทียบกับเกณฑ์อ้างอิง และสรุปผลรวมว่าทำไมเมล่อนจึงถูกจัดอยู่ในระดับความสุกนั้น**
* **รูปแบบการเขียน reason ควรเป็นการวิเคราะห์เรียงลำดับเป็นข้อ ๆ เช่น:**  
  1. ค่า pH = 5.6 อยู่ในช่วงของ "สุก" (5.48 - 6.12)  
  2. ค่า Brix = 12.3 สูงกว่าเกณฑ์เน่าเสีย (≤ 8.20) จึงถือว่าไม่ใช่เน่าเสีย  
  3. ความแน่น = 10 N ต่ำกว่า 11 N จัดเป็น "เน่าเสีย" เป็นต้น  
  **และสรุปท้ายว่าเหตุใดภาพรวมจึงเป็น เริ่มสุก / สุก / เน่าเสีย**
...
โปรดตอบกลับในรูปแบบ JSON เท่านั้น โดยมีโครงสร้างดังนี้:
{
  ...
  "reason": "คำอธิบายเหตุผลที่ทำให้ตัดสินใจว่าเมล่อนอยู่ในระดับความสุกใดอย่างละเอียด หรือเหตุผลที่ทำให้ไม่สามารถพิจารณาได้อย่างละเอียด (พร้อมบอกจำนวนมิติข้อมูลที่ขาดหายไปและคาดการณ์จำนวนวันก่อนเน่าเสียโดยอ้างอิงจากคำบรรยายของผู้ใช้งาน)"
}
"""
