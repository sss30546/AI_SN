...
โปรดตอบกลับในรูปแบบ JSON เท่านั้น โดยมีโครงสร้างดังนี้:
{
  ...
  "สีของเนื้อเมลอน": "เนื้อสีเขียว" หรือ "เนื้อสีเหลือง" หรือ "เนื้อสีเหลืองช้ำ" หรือ "ไม่สามารถพิจารณาได้"
  "กลิ่นเมล่อน":"กลิ่นหอมหวาน" หรือ "กลิ่นหอมน้อยลง,มีกลิ่นเปรี้ยวเล็กน้อย" หรือ "กลิ่นเหม็นรุนแรงคล้ายแอลกอฮอล์"หรือ "ไม่สามารถพิจารณาได้"
        ...
        if msg["role"] == "user":
            ...
            try:
                ...
                with st.container():
                    ...
                    col2.metric("กลิ่น", data.get("smell", "ไม่ระบุ"))
                    col2.metric("สี", data.get("color", "ไม่ระบุ"))
