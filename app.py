...
* ก่อนตัดสินใจให้พิจารณาว่ามีข้อมูลครบทั้ง 6 มิติหรือไม่ ได้แก่:
  ...
  ❗❗❗ ห้ามเดา หากข้อมูลไม่ครบอย่างน้อย 3 มิติ **ให้ตอบว่า "ripeness": "ไม่สามารถพิจารณาได้" เท่านั้น ห้ามประเมินเด็ดขาด**❗❗❗
  หากมีข้อมูลเพียง 1 หรือ 2 มิติ เช่น มีแค่ค่า pH กับ Brix หรือแค่กลิ่นกับสี ให้ถือว่า "ไม่สามารถพิจารณาได้" ทันที ห้ามใช้เหตุผลอื่นในการตีความเพิ่มเติมเอง
"""
